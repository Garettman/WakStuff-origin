              ...
              if (list_found.length === 1) {
                  try {
                      ...
                      message.member.createDM().then(dm => {
                          dm.send("can't send message in #" + message.channel.name + ". commands.js error.");
                      });
                  }
              } else {
                      ...
                      collector.on('collect', collected => {
                          ...
                          try {
                                  let embed_item = new Discord.MessageEmbed()
                                      .setTitle(list_found[parseInt(collected.values[0])].name_fr)
                              ...
                              message.member.createDM().then(dm => {
                                  dm.send("can't send message in #" + message.channel.name + ". Collector error.");
                              });
                          }
                      });
